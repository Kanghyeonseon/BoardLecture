...
public class C01ShowBusInfo extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String addr = "http://apis.data.go.kr/1613000/ExpBusInfoService/getExpBusTrminlList?serviceKey=zqrTLXprDh1OiWtWKnl8n42o82x0HbxEwwFwccjuddzWmFJuLx5puGR4aHoysM2KS0N788d3g625pT7hPJfCaw%3D%3D&pageNo=1&numOfRows=230&_type=json";
